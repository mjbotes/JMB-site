<?php
	...
	if ($_SESSION["is_login"] === true) {
		...
		echo $ad.'<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="gift" 
		...
		40-40 40z"></path></svg> '.$t_q.' R '.$tot.' | <a href="account.php">'.$_SESSION["Name"].'</a> | <a href="user_scripts/logout.php">logout</a>';
	} else {
